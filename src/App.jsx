    ...
    <>
      ...
      >
        ...
        <div style={{color:"white",fontFamily:" math",  width:"50%"}}>
          <p style={{fontSize:"435%",fontWeight:"bold", lineHeight:"1em"}}>THE ULTIMATE BURGER HAVEN</p>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempore provident dicta esse perspiciatis obcaecati iste dolore accusamus dolorem a corrupti. Culpa quidem ut accusamus optio a ullam ratione eaque odio!</p>
        </div>
        <div>
          <Button className={style.button}>
            Order Now
          </Button>
          <Button className={style.button}>View Mean</Button>
        </div>
        </Container>

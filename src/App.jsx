  ...
  return (
    <>
      <div
        ...
        className="container"
      >
        <div style={{display:"flex",alignItems:"center" ,color:"white", justifyContent:"space-evenly"}} className="Nav">
          <img style={{ width: "30px" }} src="/image/burgerLogo.jpg" alt="" />
          <div
          style={{display:"flex",
